        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <form class="form-horizontal" action="{{ route('save_property') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('sale_type') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-8">
                        <select name="sale_type" value="" class="form-control">
                  ...
                  <div class="form-group{{ $errors->has('date_registered') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                    <input class="form-control" type="date" name="date_registered" value="">
                ...
                <div class="form-group{{ $errors->has('deal_status') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                    <select name="deal_status" value="" class="form-control">
                ...
                <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                    <textarea class="form-control" name="review" rows="8" cols="80" placeholder="Property comments/review"></textarea>
